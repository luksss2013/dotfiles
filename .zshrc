...
# --- User additions: WSL2 + WezTerm + zoxide + fzf + atuin ---
...
typeset -U PATH path
path=(
  /home/lucas-default/.opencode/bin
  /home/lucas-default/.local/bin
  $path
)
export PATH

# zoxide (replaces rupa/z from antidote plugins)
eval "$(zoxide init zsh)"

# fnm — removed; replaced by Vite+ via setup_vite_plus below
...
__wezterm_set_user_var() {
  if [[ -n "$WEZTERM_UNIX_SOCKET" || -n "$WEZTERM_PANE" ]]; then
...
precmd_functions+=(__wezterm_hook)
...
# pnpm
export PNPM_HOME="/home/lucas-default/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME/bin:"*) ;;
